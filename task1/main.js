...
// 1. Favorite Songs
const favoriteSongs = ["Tiny Dancer", "Running up the hill" , "dont stop moving", "tragedy", "crazy horses"];

// 2. Profit From First Seven Days
//  of Tao's Penny Doubling Pyramid Scheme
const pyramidSchemeProfit = ["1", "2", "4", "8", "16", "32", "64"];
